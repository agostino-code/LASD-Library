...
/* ************************************************************************** */
    ...
    public:
      ...
      // Specific member functions (inherited from MappableContainer)
        ...
        virtual void Map(MapFunctor, void*) override = 0; // Override MappableContainer member
    ...
    public:
      ...
      // Specific member functions (inherited from FoldableContainer)
        ...
        virtual void Fold(FoldFunctor, const void*, void*) const override = 0; // Override FoldableContainer member
